	...
	<div class="pos_featured_product product_block_container" >
		<div class="container" >
			...
			<div class="row pos_content " >
				<div class="products featuredSlide " style="float: left; width:25%" dir-paginate="sp in product1|itemsPerPage:itemPerPage">
...
<div class="container">
	<ul class="tabs_slider"> 
		...
		<div class="row pos_content ">  
			<div id="tab_special_product" class="tab_content" style="float: left; width:25%" dir-paginate="sp in products|itemsPerPage:itemPerPage">
				<div class="productTabContent0">
					<div class="item-product" style=" width:340px">
								
						<article class="js-product-miniature item_in" data-id-product="8" data-id-product-attribute="51" itemscope itemtype="http://schema.org/Product">
							<div class="img_block">
		
								<a href="home/8-51-fusion-backpacks.html#/1-size-s/13-color-orange" class="thumbnail product-thumbnail">
									<img
									src = "/images/@{{sp.anh}}"
								...
								<div class="block-inner">
									...
									<a href="home/8-51-fusion-backpacks.html#/1-size-s/13-color-orange" title="Fusion Backpacks" class="detail"><i class="ion-ios-copy"></i></a>
								</div>
    						...
    						<div class="product_desc">
								<div class="manufacturer"><a href="1_fashion-manufacturer.html">Fashion Manufacturer</a></div>
       								...
       								<h4><a href="home/8-51-fusion-backpacks.html#/1-size-s/13-color-orange" style="height:50px"   title="Fusion Backpacks" itemprop="name" class="product_name">@{{sp.ten_sp}}</a></h4>
      
      
                  					<div class="product-price-and-shipping">
                          

									<span class="regular-price">@{{sp.gia |number:0}}</span>
													<span class="discount-percentage">-6%</span>
                          
            

            						<span itemprop="price" class="price  price_sale">$103.40</span>
