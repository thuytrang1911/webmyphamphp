                    ...
                    <div id="left-column" class="col-xs-12 col-sm-4 col-md-3">
                        <div class="block-categories">
                            <ul class="category-top-menu">
                                <li><a class="text-uppercase h6" href="shop">Shop</a></li>
                                <li>
                                ...
                                <section class="facet">
                                    ...
                                    <ul id="facet_91544" class="collapse" ng-repeat="th in thuonghieus">
                                        <li>
                                            ...
                                            <a href="productbybrand" ng-click="saveTH(th.id)"  rel="nofollow">@{{th.ten_thuong_hieu}}</a>
                                            </label>
                                        </li>
                                    </ul>
                                </section>
                                ...
                                <div id="">
                                    <div id="js-product-list">
                                        <div class="products row product_content grid">
                                            <div class="item-product col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3" dir-paginate="sp in products|filter: timkiem|itemsPerPage:itemPerPaget" style=" float:left">
