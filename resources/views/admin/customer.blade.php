...
<div class="item-title">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    <tr dir-paginate="kh in khachhangs|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{kh.ten_kh}}</td>
                                        <td>@{{kh.dia_chi}}</td>
                                        <td>@{{kh.sdt}}</td>
                                        
                                        <td><button class="btn btn-info fa fa-pen" ng-click="showmodal(kh.id)">&nbsp;</button></td>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khachhang.ten_kh">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khachhang.dia_chi">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khachhang.sdt">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khachhang.usersname">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khachhang.password">
                                        </div>
                                    </div>
                                </div>
                            </div>
