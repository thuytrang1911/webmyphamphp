...
<div class="item-title">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    <tr dir-paginate="d in dongs|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{d.ten_dong}}</td>
                                    
                                        <td><button class="btn btn-info fa fa-pen" ng-click="showmodal(d.id)">&nbsp;</button></td>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="dong.ten_dong">
                                        </div>
                                    </div>
                                </div>
