                            ...
                            <thead>
                                ...
                                <tbody>
                                    <tr dir-paginate="th in blogs|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td><img src="/images/@{{th.anh}}" style='width:100px' /></td>
                                        <td >@{{th.tieu_de}}</td>
                                        <td style="width: 500px; overflow: hidden;text-overflow: ellipsis;line-height: 25px;
                                            ...
                                            @{{th.noi_dung}}</td>
                                        <!-- <td style='width:300px'>@{{th.noi_dung}}</td> -->
                                        <td>@{{th.nv.tennv}}</td>
                                ...
                                <div class="container-fluid" >
                                    <div class="form-group">
                                        <div ng-model="blog"  > 
                                            ...
                                            <select class="form-control" ng-model='blog.id_nv' >
                                                <option value="" selected>@{{blog.id_nv}}</option>
