<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="hdbancontroller">
<head>
    <meta charset="utf-8">
...
<div class="item-title">
                        ...
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    <tr dir-paginate="hd in hdbans|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td ng-click="Billsdetail(hd.id)">@{{hd.kh.ten_kh}}</td>
                                        <td>@{{hd.dia_chi_nhan}}</td>
                                        <td>@{{hd.ngay_dat}}</td>
                                        <td>@{{hd.tong_tien}}</td>
                            ...
                            <div class="container-fluid" >
                                    <div class="form-group">
                                        <div ng-model="hdban"  > 
                                            ...
                                            <select class="form-control" ng-model='hdban.id_kh' >
                                                <option value="" selected>@{{hdban.id_kh}}</option>
                                                <option ng-repeat="kh in khachhangs" value="@{{kh.id}}">@{{kh.ten_kh}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="hdban.dia_chi_nhan">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="hdban.ngay_dat">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="hdban.ht_thanh_toan">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table table-border text-nowrap">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="sp in CTHDBan">
                                                    <td class="image-prod"><img class="img" style="width:100px;heigh:100px" src="/images/@{{sp.anh}}"></img></td>					        
                                        ...
                                        <!-- <ul>
                                            <li>Tổng tiền <span style="float:right;padding-right:20px" class="total">@{{total |number : 0 }}đ</span></li>
                                        </ul> -->
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <script src="/JS/hdbancontroller.js"> </script> 
